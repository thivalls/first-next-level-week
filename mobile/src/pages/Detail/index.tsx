  ...
  return (
    <SafeAreaView style={{flex: 1}}>
      <View style={styles.container}>
        ...
        <Text style={styles.pointName}>Extra</Text>
        <Text style={styles.pointItems}>Oleo, lampadas</Text>

        <View style={styles.address}>
          <Text style={styles.addressTitle}>Endereço</Text>
          <Text style={styles.addressContent}>Rua alameda do flamboiants, 1240, SC</Text>
        </View>
      </View>
